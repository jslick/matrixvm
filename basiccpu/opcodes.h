...
#define REG_R1  (  1 << INS_REG )
#define REG_R2  (  2 << INS_REG )
#define REG_R3  (  3 << INS_REG )
#define REG_R4  (  4 << INS_REG )
#define REG_R5  (  5 << INS_REG )
#define REG_R6  (  6 << INS_REG )
#define REG_R7  (  7 << INS_REG )
#define REG_SP  ( 11 << INS_REG )
#define REG_LR  ( 12 << INS_REG )
#define REG_IP  ( 13 << INS_REG )
#define REG_DL  ( 14 << INS_REG )
#define REG_ST  ( 15 << INS_REG )
